...
//           setSelectedCategory(null); // Initialize with no category selected
//         }
//       } else {
...
//     setDropdownOpen(false);
//     setSearchQuery("");
//     setSelectedCategory(null); // Reset category on site change
//     setFilteredData(reckonerData); // Show all records initially
//   };
...
//               </div>
//               {/* <div className="mb-3">
//                 <span className="font-medium text-sm">Progress:</span> Area{" "}
//                 <span className="font-semibold">{parseFloat(r.area_completed) || 0}</span> | Value{" "}
//                 <span className="font-semibold">{r.completion_value || 0}</span>
//               </div> */}
