...
const ViewAssignedMaterial = () => {
  ...
  const fetchTransportTypes = async () => {
    try {
      ...
      const response = await axios.get("http://3.211.76.159/api/material/transport-types");
  ...
  const fetchProviders = async (transport_type_id) => {
    try {
      ...
      const response = await axios.get("http://3.211.76.159/api/material/providers", {
  ...
  const fetchVehicles = async () => {
    try {
      ...
      const response = await axios.get("http://3.211.76.159/api/material/vehicles");
  ...
  const fetchDrivers = async () => {
    try {
      ...
      const response = await axios.get("http://3.211.76.159/api/material/drivers");
  ...
  const fetchAssignedMaterials = async () => {
    ...
    try {
      ...
      setError(null);
      const response = await axios.get("http://3.211.76.159/api/material/assignments-with-dispatch", {
  ...
  const handleDispatchSubmit = async () => {
    try {
      ...
      const response = await axios.post("http://3.211.76.159/api/material/add-dispatch", payload);
